...
.. raw:: html
    ...
    <p>Start App Inventor with <a href="http://ai2a.appinventor.mit.edu/?repo=templates.appinventor.mit.edu/trincoll/csp/unit7/templates/DataMap/DataMapTemplate.asc" target="_blank">Data Map App Template</a>.  Once the project opens use Save As to rename your project. 
    </p><p>
    Follow the video tutorial below or the <a href="https://docs.google.com/document/d/1B7XFoyVv8Dk6Ek-xlYzNkZCfCfc4RQ4yFQq6pmpv9Ps/" target="_blank">text tutorial</a> or the <a href="https://docs.google.com/document/d/1wdxBIXOzXy9bAqy1hYF5-SZ7xfPnAK7UZKwz4HK8wbQ/" target="_blank">short handout</a> to complete this app:<br/>
